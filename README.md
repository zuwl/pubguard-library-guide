...
The latest version of the Android Pubguard Library is **1.0.11**
...
...
    ...
    implementation 'com.pubguard:pubguard-client:1.0.11'
...
The latest version of the iOS Pubguard Library is **1.0.6**
...
```
pod 'Pubguard', podspec: 'https://customer.pubguard.com/cocoapods/pubguard-ios-framework/latest/Pubguard.podspec?access_token=${pubguardKey}'
```
