...
The latest version of the iOS Pubguard Library is **1.23.1**
...
```
pod 'Pubguard', podspec: 'https://customer.pubguard.com/cocoapods/pubguard-ios-framework/1.23.1/Pubguard-1.23.1.podspec?access_token=YOUR_PUBGUARD_KEY_HERE'
```
