...
...
    ...
    implementation 'com.pubguard:pubguard-client:1.2.0'
...
The latest version of the iOS Pubguard Library is **1.7.0**
...
```
pod 'Pubguard', podspec: 'https://customer.pubguard.com/cocoapods/pubguard-ios-framework/1.7.0/Pubguard-1.7.0.podspec?access_token=YOUR_PUBGUARD_KEY_HERE'
```
