...
The latest version of the iOS Pubguard Library is **1.7.2**
...
```
pod 'Pubguard', podspec: 'https://customer.pubguard.com/cocoapods/pubguard-ios-framework/1.7.2/Pubguard-1.7.2.podspec?access_token=YOUR_PUBGUARD_KEY_HERE'
```
