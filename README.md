...
The latest version of the Android Pubguard Library is **1.7.0**
...
...
    ...
    implementation 'com.pubguard:pubguard-client:1.7.0'
...
The latest version of the iOS Pubguard Library is **1.8.1**
...
```
pod 'Pubguard', podspec: 'https://customer.pubguard.com/cocoapods/pubguard-ios-framework/1.8.1/Pubguard-1.8.1.podspec?access_token=YOUR_PUBGUARD_KEY_HERE'
```
